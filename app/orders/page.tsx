            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              {/* <div>
                ...
                <input
                  ...
                  value={minGrandTotal}
                  onChange={(e) => {
                    setMinGrandTotal(e.target.value);
                    setAndResetPage({
                      minGrandTotal: e.target.value || undefined,
                      page: 1,
                    });
                  }}
                />
              ...
              {/* <div>
                ...
                <input
                  ...
                  value={maxGrandTotal}
                  onChange={(e) => {
                    setMaxGrandTotal(e.target.value);
                    setAndResetPage({
                      maxGrandTotal: e.target.value || undefined,
                      page: 1,
                    });
                  }}
                />
                    ...
                    <td className="px-4 py-3">
                      <div>
                        <div className="font-semibold text-gray-900">
                          {parseFloat(order.grandTotal).toLocaleString("vi-VN")}
                          đ
                        </div>
                        <span
