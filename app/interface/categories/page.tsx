          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
            ...
            <div className="flex gap-2">
              <Button
                ...
                onClick={() =>
                  router.push(Routes.interface.categories.review)
                }
              >
              ...
              <Button
                onClick={() =>
                  router.push(Routes.interface.categories.add)
                }
                        ...
                        <td className="px-4 py-3">
                          <div className="flex items-center gap-2">
                            <Button
                              ...
                              onClick={() =>
                                router.push(
                                  Routes.interface.categories.viewDetails.replace(
                                    "[id]",
                                    c.id
                                  )
                                )
                            ...
                            <Button
                              ...
                              onClick={() =>
                                router.push(
                                  Routes.interface.categories.edit.replace(
                                    "[id]",
                                    c.id
                                  )
                                )
