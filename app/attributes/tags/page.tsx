      ...
      <main className="max-w-[1440px] mx-auto py-6 px-4 lg:px-8">
        ...
        >
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
            <div>
              <h1 className="text-3xl font-bold text-gray-800">Nhãn {meta?.totalItems !== undefined && `(${meta.totalItems})`}</h1>
            ...
            <div className="flex gap-2">
              <Button
                ...
                onClick={() =>
                  router.push(Routes.attributes.tags.trash)
                }
              >
              ...
              <Button
                onClick={() => router.push(Routes.attributes.tags.add)}
                        ...
                        <td className="px-6 py-3">
                          <div className="flex items-center justify-center gap-2">
                            <Button
                              ...
                              onClick={() =>
                                router.push(
                                  Routes.attributes.tags.edit.replace(
                                    "[id]",
                                    t.id
                                  )
                                )
