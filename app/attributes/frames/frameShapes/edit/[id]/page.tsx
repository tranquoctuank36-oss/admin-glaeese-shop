...
export default function EditFrameShapePage() {
  ...
  if (!initial) return <p className="p-6 text-red-600">Không tìm thấy hình dạng gọng kính.</p>;

  return (
    <div className="flex-1 overflow-auto relative z-10">
      <main className="max-w-[600px] mx-auto py-6 px-4 lg:px-8">
        <h1 className="text-3xl font-bold text-gray-800 mb-6">
          Chỉnh sửa hình dạng gọng kính
        </h1>
        ...
        <FrameShapeForm
          ...
          onSubmit={async (values) => {
            ...
            toast.success("Hình dạng gọng kính đã được cập nhật thành công!");
          }}
