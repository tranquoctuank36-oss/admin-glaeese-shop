  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      try {
        ...
        console.error("Failed to fetch frame types:", e);
        if (alive) {
          setRows([]);
          setMeta(undefined);
        }
          ...
          <div className="flex flex-col sm:flex-row justify-end items-start sm:items-center gap-4 mb-6">
            ...
            <div className="flex gap-2">
              {/* <Button
                ...
                onClick={() =>
                  router.push(Routes.attributes.frames.frameTypes.trash)
                }
              >
              ...
              <Button
                onClick={() =>
                  router.push(Routes.attributes.frames.frameTypes.add)
                }
                  ...
                  <tbody className="divide-y divide-gray-200">
                    {rows.map((type) => (
                      ...
                      >
                        ...
                        <td className="px-6 py-4">
                          <span className="text-gray-600">{type.slug}</span>
                        </td>
                          ...
                          <div className="flex items-center justify-center gap-2">
                            ...
                            <ConfirmPopover
                              ...
                              onConfirm={async () => {
                                ...
                                try {
                                  await handleSoftDelete(type.id);
                                } finally {
                                  setDeletingId(null);
                                }
                              }}
                              confirmDisabled={deletingId === type.id}
                              confirmLoading={deletingId === type.id}
