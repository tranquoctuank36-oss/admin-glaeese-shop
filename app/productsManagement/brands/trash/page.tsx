...
export default function BrandsTrashPage() {
    ...
    (async () => {
      ...
      try {
        ...
        setMeta({
          ...
          totalItems: res.meta?.totalItems ?? res.meta?.totalItems,
        });
        setHasNext(!!res.hasNext);
        setHasPrev(!!res.hasPrev);
      } catch (e) {
        console.error("Failed to fetch deleted brands:", e);
        if (alive) {
          setRows([]);
          setMeta(undefined);
          setHasNext(false);
  ...
  // tính totalPages fallback khi server chỉ trả totalItems
    ...
    <div className="flex-1 overflow-auto relative z-10">
      <main className="max-w-[1440px] mx-auto py-6 px-4 lg:px-8">
        ...
        >
          ...
          {/* Ẩn filter Active trong thùng rác */}
          ...
          >
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <ConfirmPopover
                              ...
                              onConfirm={async () => {
                                setBusyId(b.id);
                                try {
                                  await handleRestore(b.id);
                                } finally {
                                  setBusyId(null);
                                }
                              }}
                              confirmDisabled={busyId === b.id}
                              confirmLoading={busyId === b.id}
            ...
            <div className="flex items-center justify-between p-4">
              ...
              <Pagination
                ...
                hasNext={hasNext}
                onChange={(p) => {
                  const capped = safeTotalPages
                    ? Math.min(p, safeTotalPages)
                    : p;
